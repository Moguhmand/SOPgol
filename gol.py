...
def addGlider(i, j, grid): 
    ...
    # initierer en glider med øverste højre celle i (i, j)
...
def addGosperGliderGun(i, j, grid): 
    ...
    # initierer en Gosper Glider med øverste højre celle i (i, j)
...
def main():
    ...
    else:   # ellers fyld grid tilfældigt (mere OFF end ON)
        grid = randomGrid(N)
